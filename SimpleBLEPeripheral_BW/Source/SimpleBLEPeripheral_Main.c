...
#define LOAD_APP_VER          0x0100
#define LOAD_MAGIC_TYPE       0x55aa
#define LOAD_MAGIC_FEATURE    0xbe01

#pragma location=0x0900
const CODE uint16 appVer = LOAD_APP_VER;
#pragma required=appVer

#pragma location=0x0A00
const CODE uint16 magicType = LOAD_MAGIC_TYPE;
#pragma required=magicType

#pragma location=0x1000
const CODE uint16 magicFeature = LOAD_MAGIC_FEATURE;
#pragma required=magicFeature

//！！！请注意：正式发布前必须置FALSE
uint8 g_licenseGoodFlag = TRUE; //TRUE;//FALSE;
