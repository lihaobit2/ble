...
extern uint8 NPI_ReadByte(uint8 *buf);
extern uint16 NPI_WriteTransport( uint8 *, uint16 );
extern uint16 NPI_WriteString( char *buf);
extern uint16 NPI_WriteStrValue(char *buf, uint16 value);
extern uint16 NPI_WriteStrValue2( char *buf,int16 var1, int16 var2);
extern void NPI_WriteByte( uint8 byte);
